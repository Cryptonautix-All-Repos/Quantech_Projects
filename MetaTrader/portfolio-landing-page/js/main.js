...
(function() {
    ...
    function initTypingEffect() {
        ...
        if (!heroTitle || AppState.userPreferences.reducedMotion) return;
        ...
        function typeWriter() {
            ...
            if (!isDeleting && currentCharIndex === currentWord.length) {
                ...
                if (currentWordIndex === words.length - 1) {
                    // Finished typing all words, keep the full text
    ...
    function initSearchFunctionality() {
        ...
        searchInput.placeholder = 'Search strategies...';
        searchInput.className = 'strategy-search';
    ...
    function searchStrategies(query) {
        ...
        strategyCards.forEach(card => {
            ...
            const features = Array.from(card.querySelectorAll('.key-features li'))
    ...
    function initKeyboardNavigation() {
        document.addEventListener('keydown', (e) => {
            ...
            if (e.altKey && e.key === 's') {
                e.preventDefault();
                const searchInput = document.querySelector('.strategy-search');
                if (searchInput) {
                    searchInput.focus();
                }
            }
